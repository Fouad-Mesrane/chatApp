      ...
      <div className="max-w-2xl mx-auto p-4 py-8">
        <div className="bg-base-300 rounded-xl p-6 space-y-8">
          <div className="text-center">
            <h1 className="text-2xl font-seimbold">Profile</h1>
          ...
          <div className="p-6 rounded-xl mt-6">
            ...
            <div className="space-y-3 text-sm text-zinc-400 flex items-center justify-between py-2 border-b border-zinc-700">
